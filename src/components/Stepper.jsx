...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'rgba(15,0,32,0.8)', color: '#6b7280', border: '2px solid rgba(132,0,255,0.3)' },
          active:   { scale: 1.1, backgroundColor: '#6b21e8', color: '#fff', border: '2px solid #a78bfa' },
          complete: { scale: 1, backgroundColor: '#4c1d95', color: '#a78bfa', border: '2px solid #6b21e8' }
        }}
    ...
    <div className="stepper-connector">
      <motion.div
        ...
        variants={{
          ...
          complete:   { width: '100%', backgroundColor: '#6b21e8' }
        }}
        initial={false}
